...
@interface secOutViewController ()<ViewWillShow>

@end

@implementation secOutViewController
...
-(void)down{
    ...
    [self addTaskUrl:[NSString stringWithFormat:SecOut,self.currentPage ]];
}
-(void)creatRefresh{
    ...
    [_mytableView addRefreshHeaderViewWithAniViewClass:[JHRefreshCommonAniView class] beginRefresh:^{
        ...
        [weakSelf addTaskUrl:[NSString stringWithFormat:SecOut,weakSelf.currentPage]];
        NSLog(@"已刷新");
    }];
