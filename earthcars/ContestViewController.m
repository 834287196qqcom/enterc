...
#import "FirstCell.h"
@interface ContestViewController ()<ViewWillShow,UITableViewDataSource,UITableViewDelegate>
...
-(void)down{
    ...
    [self addTaskUrl:[NSString stringWithFormat:Contest,self.currentPage ]];
}
-(void)creatView{
...
-(void)creatRefresh{
    ...
    [_mytableView addRefreshHeaderViewWithAniViewClass:[JHRefreshCommonAniView class] beginRefresh:^{
        ...
        [weakSelf addTaskUrl:[NSString stringWithFormat:Contest,weakSelf.currentPage]];
        NSLog(@"已刷新");
    }];
