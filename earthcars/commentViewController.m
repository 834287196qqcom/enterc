...
#import "FirstCell.h"
@interface commentViewController ()<ViewWillShow,UITableViewDataSource,UITableViewDelegate>
...
-(void)down{
    ...
    [self addTaskUrl:[NSString stringWithFormat:comment,self.currentPage ]];
}
-(void)creatView{
...
-(void)creatRefresh{
    ...
    [_mytableView addRefreshHeaderViewWithAniViewClass:[JHRefreshCommonAniView class] beginRefresh:^{
        ...
        [weakSelf addTaskUrl:[NSString stringWithFormat:comment,weakSelf.currentPage]];
        NSLog(@"已刷新");
    }];
