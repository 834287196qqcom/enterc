...
#import "FirstCell.h"
@interface VisitViewController ()<ViewWillShow,UITableViewDataSource,UITableViewDelegate>
...
-(void)down{
    ...
    [self addTaskUrl:[NSString stringWithFormat:Visit,self.currentPage ]];
}
-(void)creatRefresh{
    ...
    [_mytableView addRefreshHeaderViewWithAniViewClass:[JHRefreshCommonAniView class] beginRefresh:^{
        ...
        [weakSelf addTaskUrl:[NSString stringWithFormat:Visit,weakSelf.currentPage]];
        NSLog(@"已刷新");
    }];
