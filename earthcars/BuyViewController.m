...
#import "FirstCell.h"
@interface BuyViewController ()<ViewWillShow,UITableViewDataSource,UITableViewDelegate>
...
-(void)down{
    ...
    [self addTaskUrl:[NSString stringWithFormat:Buy,self.currentPage ]];
}
-(void)creatView{
...
-(void)creatRefresh{
    ...
    [_mytableView addRefreshHeaderViewWithAniViewClass:[JHRefreshCommonAniView class] beginRefresh:^{
        ...
        [weakSelf addTaskUrl:[NSString stringWithFormat:Buy,weakSelf.currentPage]];
        NSLog(@"已刷新");
    }];
